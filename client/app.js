...
const App = () => {
  const Logout = () => {
    // this where the logout request is made to the /logout end point
    console.log(' clicked log out ');
    fetch('/logout').catch(err => console.log(err));
  };
  ...
  return (
    <Router>
      <Header>
        ...
        <RightNav>
          <Link className="right-link" to="/projectpage">
            Projects
          </Link>
          <LogoutBtn className="right-link" onClick={Logout}>
            Logout
          </LogoutBtn>
        </RightNav>
      </Header>
